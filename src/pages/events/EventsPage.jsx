...
const EventsPage = () => {
  const events = [
    {
      id: 'prince-turki',
      title: 'محاضرة: مستقبل العالم العربي في ضوء المتغيرات الراهنة',
      date: '2025/05/24',
      time: '10:00 صباحاً',
      ...
      image: '/assets/images/prince-turki.jpeg',
      slug: 'lecture/prince-turki'
    },
    {
      id: 1,
      ...
      <div className="container mx-auto px-4 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {events.map((event) => (
            ...
            >
              {/* محاضرة الأمير تركي الفيصل - عرض خاص */}
              {event.id === 'prince-turki' ? (
                <>
                  <div className="relative">
                    ...
                    <div className="absolute top-4 right-4 bg-primary-600 text-white px-3 py-1 rounded-md text-sm font-medium">
                      محاضرة خاصة
                    </div>
                  ...
                  <div className="p-6">
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="pt-2">
                        <Link 
                          to="/prince-turki"
                          className="w-full sm:w-auto inline-block px-6 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors text-sm sm:text-base text-center"
                        >
                          عرض التفاصيل
                        </Link>
                      </div>
